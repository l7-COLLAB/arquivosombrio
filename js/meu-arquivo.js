...
function abrirSecaoMeuArquivo(nome, atualizarHash = true) {
    ...
    const botaoVoltar = document.getElementById("arquivo-view-back");
    if (botaoVoltar) botaoVoltar.hidden = nome === "inicio";
...
function inicializarNavegacaoMeuArquivo() {
    document.getElementById("arquivo-view-back")?.addEventListener("click", () => {
        abrirSecaoMeuArquivo("inicio");
    });
