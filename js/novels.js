...
const params=new URLSearchParams(location.search);const slug=params.get("obra"),hasChapter=params.has("capitulo"),cap=hasChapter?Number(params.get("capitulo")):null;
