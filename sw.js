const VERSION = "arquivo-sombrio-20260914-admin-core-4";
...
self.addEventListener("fetch", event => {
  ...
  event.respondWith((async () => {
    try {
      ...
      const inject = '<script src="js/arquivo-literario-bootstrap.js?v=20260914-2340"></script><script src="js/admin-literario.js?v=20260914-2340"></script><script src="js/admin-core-tabs.js?v=20260914-2340"></script>';
